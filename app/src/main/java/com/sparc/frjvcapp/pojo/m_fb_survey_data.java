...
public class m_fb_survey_data implements Serializable {
    ...
    public void setPast_lat(String past_lat) {
        this.past_lat = past_lat;
    }

    public String getPast_long() {
        return past_long;
    }

    public void setPast_long(String past_long) {
        this.past_long = past_long;
    }

    private String past_lat;
    private String past_long;
    ...
    public m_fb_survey_data(String d_id, String r_id, String fb_id,String p_sl_no,
                            String p_lat, String p_long, String p_type, String p_cond,
